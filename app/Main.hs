...
data TranslateOptions = TranslateOptions WriteFile NoGoFmt FilePath
...
doTrans (TranslateOptions toFile noGofmt filePath) = translateFile outputResult filePath noGofmt
    where
        outputResult = if toFile
            then writeFileUtf8 (replaceExtension filePath ".go") . addHeader
            else putStrLn

        addHeader t = "// Code generated by " <> titleWithVersion <> ".  DO NOT EDIT.\n" <> t
